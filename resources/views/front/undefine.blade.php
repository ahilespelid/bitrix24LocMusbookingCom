...
<div style="padding-top: 15px; width:100%; background: rgb(255,255,255);">
    ...
    <div style="width:100%; height: 50px; background: #ffffff; min-height: 55px;">
        <div class="head">
            <div class="head_el">
    ...
    <div style="width:100%; height: 55vh; background: rgb(250,250,250);">
        <div class="body">
        <table>
            <tbody>
                <tr>
    ...
    <div style="width:100%; height: 30vh; background: rgb(250,250,250);"> 
        <div class="card">
                <div class="card__fl">
                    ...
                    <div class="card__fl_clients_item-item">
                        <ul>
                            <li>
                                <div class="caption comment">Комментарий сотрудника</div>
                                <div><strong>Импорт из google: 28.06.2023 13:00:00-28.06.2023 18:00:00</strong></div>
                            </li>
                        </ul>
                    </div>
                    
                    <div class="card__fl_clients_item">
                        <div class="clients_card-item buttons_align">
                            <button type="button" class="btn-deteil btn_card_calendar v-btn v-btn--round theme--light primary">
                                <div class="v-btn__content">Детали заказа</div>
                            </button>
                            <div class="clients_card-item">
                                <button type="button" class="btn_card_calendar btn-collection v-btn v-btn--round theme--light">
                                    <div class="v-btn__content">Отменить без сбора</div>
                                </button>
                            </div>
                        </div>
                        <div class="clients_card-item buttons_align"></div>
                        <div>
